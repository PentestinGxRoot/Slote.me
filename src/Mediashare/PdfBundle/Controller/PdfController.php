...
use Mediashare\PdfBundle\Entity\Pdf;
use Mediashare\PdfBundle\Form\PdfType;
...
class PdfController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MediasharePdfBundle:Pdf')->findAll();

        return $this->render('MediasharePdfBundle:Pdf:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MediasharePdfBundle:Pdf:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MediasharePdfBundle:Pdf')->find($id);
        ...
        return $this->render('MediasharePdfBundle:Pdf:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MediasharePdfBundle:Pdf:edit.html.twig', array(
            'entity'      => $entity,
