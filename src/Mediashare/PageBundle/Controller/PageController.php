...
use Mediashare\PageBundle\Entity\Page;
use Mediashare\PageBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MediasharePageBundle:Page')->findAll();

        return $this->render('MediasharePageBundle:Page:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MediasharePageBundle:Page:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MediasharePageBundle:Page')->find($id);
        ...
        return $this->render('MediasharePageBundle:Page:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MediasharePageBundle:Page:edit.html.twig', array(
            'entity'      => $entity,
