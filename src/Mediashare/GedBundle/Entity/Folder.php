...
namespace Mediashare\GedBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="Mediashare\GedBundle\Entity\FolderRepository")
...
class Folder
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Mediashare\UserBundle\Entity\User", inversedBy="folders")
